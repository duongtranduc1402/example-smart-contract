...
abstract contract SignatureMintERC721 is EIP712, ISignatureMintERC721 {
    ...
    keccak256(
            "MintRequest(address to,address primarySaleRecipient,string uri,uint256 quantity,uint256 pricePerToken,address currency,uint128 validityStartTimestamp,uint128 validityEndTimestamp,bytes32 uid)"
        );
